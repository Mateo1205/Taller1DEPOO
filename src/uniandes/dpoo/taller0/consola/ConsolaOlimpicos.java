...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. *****Consultar el pais al que pertenece el atleta");
		System.out.println("14. *****Ejecucion de  nueva clase");
		System.out.println("15. Salir de la aplicación\n");
	}
	
	
	/**
	 * Ejecucion de la nueva clase
	 */
	
	private void ejecutarNuevaClase()
	{
	...
	/**
	 * Le muestra al usuario el pais al que pertenece el atletla
	 */
	...
	private void consultarPaisAtleta()
	{
		...
		System.out.println("El pais del atleta "+ nombreAtleta + " es: "+ pais);
